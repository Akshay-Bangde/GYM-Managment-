...
public class Expense_List_Activity extends AppCompatActivity {
    Spinner spinner_month, spinner_year;
    CoordinatorLayout mCoordinatorLayout;
    Button mSearchBtn, mSearchBtnDateWise;
    private LinearLayout mMonthYearLayout, mDateWiseLayout, mLinearLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> monthAdapter = new ArrayAdapter<String>(Expense_List_Activity.this,
        ...
        ArrayAdapter<String> yearAdapter = new ArrayAdapter<String>(Expense_List_Activity.this,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Expense_List_Activity.this,Add_Expense_Activity.class);
                ActivityOptions options = ActivityOptions.makeCustomAnimation(Expense_List_Activity.this, R.anim.push_up_in, R.anim.push_up_out);
    ...
    /*Search function for Month Year*/
    ...
    public void SearchButtonforDateWise(){
        ...
        mStartdateEdt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(Expense_List_Activity.this, R.style.DialogTheme, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        mStartDateCalender.set(Calendar.YEAR,year);
                        mStartDateCalender.set(Calendar.MONTH,month);
