...
import com.example.smile.activities.Add_WaterIntake_Activity;
...
public class WaterIntakeListAdapter extends
        RecyclerView.Adapter<WaterIntakeListAdapter.CustomViewHolder> {

    String Delete_URL = BaseURL+"WaterIntakeGrid";
    CategoryCallBackInterface categoryCallBackInterface;

    Context context;
    private ArrayList<WaterIntakeListModel> items;

    public WaterIntakeListAdapter(Context context, ArrayList<WaterIntakeListModel> items){
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CustomViewHolder(LayoutInflater.from(context).inflate(R.layout.content_water_intake_list_,parent,false));
    }
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder customViewHolder, final int position) {
        ...
        customViewHolder.glassNo.setText(items.get(position).getGlasssNo());
        ...
        customViewHolder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Add_WaterIntake_Activity.class);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(View itemView) {
            ...
            glassNo = itemView.findViewById(R.id.NAME);
