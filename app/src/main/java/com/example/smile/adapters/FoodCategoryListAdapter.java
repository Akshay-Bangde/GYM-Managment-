...
public class FoodCategoryListAdapter extends
        RecyclerView.Adapter<FoodCategoryListAdapter.CustomViewHolder> {

    String Delete_URL = BaseURL+"VMFoodCategoryGrid";
    CategoryCallBackInterface categoryCallBackInterface;


    Context context;
    private ArrayList<FoodCategoryListModel> items;

    public FoodCategoryListAdapter(Context context, ArrayList<FoodCategoryListModel> items){
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CustomViewHolder(LayoutInflater.from(context).inflate(R.layout.content_food_category_,parent,false));
    }
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder customViewHolder, final int position) {
        ...
        customViewHolder.categoryName.setText(items.get(position).getCategory());
        customViewHolder.calories.setText(items.get(position).getTotal_Calorie());
        ...
        customViewHolder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, AddFoodCatgeory_Activity.class);
